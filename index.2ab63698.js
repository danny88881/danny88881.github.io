...
H.on('NAVIGATE_IN', ({ to , location  })=>{
    ...
    if (location.href.indexOf('#') > 0) {
        hr = location.href.substring(0, location.href.indexOf('#'));
        console.log(hr);
    }
    ...
    if (in_nav) container.classList.add('compact');
    else container.classList.remove('compact');
    // dont look at this code ):)
    body.classList.remove('games');
...
},{"./gsap-core.js":"dbpJR","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["7asJj","10GF3"], "10GF3", "parcelRequire28b7")
